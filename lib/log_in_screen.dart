	...
	//isLoading = true;
      ...
      if (response.user != null) {
        ...
        for (int i = 0; i < arr.length; i++) {
          if (arr[i]["user_email"] == _email.text.trim()) {
            currentUser = arr[i];
            userFound = true;
          }
        }
        ...
        child: SingleChildScrollView(
          child: Stack(
            ...
            children: [
              ...
              //         boxShadow: [
              //           BoxShadow(
              //             color: Color(0xFF4D4D4D).withOpacity(0.0),
              //             blurRadius: 50,
              //             spreadRadius: 50,
              ...
              decoration: const InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                    color:
                        Colors.transparent, // Change the focused border color
